...
let scene2 = sprites.create(img`
    ...
    `, SpriteKind.Player)
scaling.scaleToPercent(scene2, 255, ScaleDirection.Uniformly, ScaleAnchor.Middle)
scaling.scaleByPercent(scene2, 80, ScaleDirection.Vertically, ScaleAnchor.Middle)
